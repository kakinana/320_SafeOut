                ...
                <div class="row feature_inner">
                    <div class="col-lg-3 col-md-6">
                        <div class="feature_item">
                            <img src="img/services/s1.png" alt="logo1" style="width: 69px;"/>
                            <h4>Education</h4>
                            <p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="feature_item">
                            <img src="img/services/s2.png" alt="logo1" style="width: 69px;" />
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="feature_item">
                            <img src="img/services/s3.png" alt="logo1" style="width: 69px;" />
                            <h4>Campaign</h4>
                            <p>
                                Kalo pemerintah lama, ya kita yang gerak terlebih dahulu!
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="feature_item">
                            <img src="img/services/s4.png" alt="logo1" style="width: 69px;" />
                            <h4>Legal Assistance</h4>
                            <p>
                                Negara hukum tapi selalu tajam kebawah dan runcing ke atas, bisa bisanya.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4 col-md-6 all latest">
                            <div class="portfolio_box">
                                ...
                                <div class="short_info">
                                    <h4>
                                        <a href="https://www.medcofoundation.org/media/sd-tertinggal.jpg">
                                            Edukasi
                                        </a>
                                    </h4>
                                    <p>ke sekolah</p>
                        ...
                        <div class="col-lg-4 col-md-6 all latest">
                            <div class="portfolio_box">
                                ...
                                <div class="short_info">
                                    ...
                                    <p>Pertolongan pertama kepada para survivors</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 all popular">
                        ...
                        <div class="col-lg-4 col-md-6 all upcoming">
                            <div class="portfolio_box">
                                ...
                                <div class="short_info">
                                    ...
                                    <p>Agar panic button dapat diakses semua orang</p>
                                </div>
                            </div>
                        </div>
