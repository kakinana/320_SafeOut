...
class MapsAllActivity : AppCompatActivity() , OnMapReadyCallback, OnMarkerClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        showDialog()
        listLatLng.add(0,SafehouseModel("Universitas Telkom",LatLng(-6.972304133822665, 107.63147082328722),"Jl. Telekomunikasi. 1, Terusan Buahbatu - Bojongsoang, Telkom University, Sukapura, Kec. Dayeuhkolot, Kabupaten Bandung, Jawa Barat 40257","https://drive.google.com/file/d/1o6yPyxMzjpRxNFSL49sniHISQkcd73Q5/view?usp=share_link"))
        listLatLng.add(0,SafehouseModel("Polres Bojongsoang",LatLng(-6.981280862231196, 107.63627297975245),"Jl. Cikoneng No.18, Bojongsoang, Kec. Bojongsoang, Kabupaten Bandung, Jawa Barat 40288","https://drive.google.com/file/d/1bS2SIwukA0KJ6ajeWZjjT8NNKw5KluBt/view?usp=share_link"))
        listLatLng.add(0,SafehouseModel("DP3APPKB Jawa Barat",LatLng(-6.907966830735414, 107.61230205461473),"Jl. Sumatera No.50, Citarum, Kec. Bandung Wetan, Kota Bandung, Jawa Barat 40115","https://drive.google.com/file/d/152tNuBWhIFr2H0JtGTzLhQQjKqTxG2GI/view?usp=share_link"))
